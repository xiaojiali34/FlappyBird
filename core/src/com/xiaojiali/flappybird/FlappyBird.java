package com.xiaojiali.flappybird;
...
public class FlappyBird extends ApplicationAdapter {
	...
	public void create () {
		...
		bottomTubeRetangles = new Rectangle[numberOfTubes];
		startGame();
	...
	public void startGame() {
		...
		for (int i = 0; i < numberOfTubes; i++) {
			...
			bottomTubeRetangles[i] = new Rectangle();
		}
	}
	...
	public void render () {
		...
		if (gameState == 1) {
            ...
            for (int i = 0; i < numberOfTubes; i++) {
				...
				bottomTubeRetangles[i] = new Rectangle(tubeX[i],
						Gdx.graphics.getHeight() / 2 - gap / 2 - bottomTube.getHeight() + tubeOffset[i],
						bottomTube.getWidth(),
...
//					bottomTube.getHeight();
			...
			if (Intersector.overlaps(birdCircle, topTubeRectangles[i]) || Intersector.overlaps(birdCircle, bottomTubeRetangles[i])) {
